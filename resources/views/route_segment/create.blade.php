...
<div class="container-fluid padding-20">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('route_segment.title_create') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('route_segment.save') }}">
                        @csrf

                        <div class="form-group row">
                            <label for="lower_time_window" class="col-md-4 col-form-label text-md-right">{{ __('route_segment.label.lower_time_window') }} <b class="red-asterisk">*</b></label>
                        ...
                        <div class="form-group row">
                            <label for="upper_time_window" class="col-md-4 col-form-label text-md-right">{{ __('route_segment.label.upper_time_window') }} <b class="red-asterisk">*</b></label>
                        ...
                        <div class="form-group row">
                            <label for="route_order" class="col-md-4 col-form-label text-md-right">{{ __('route_segment.label.route_order') }} <b class="red-asterisk">*</b></label>
                        ...
                        <div class="form-group row">
                            <label for="latitude" class="col-md-4 col-form-label text-md-right">{{ __('route_segment.label.latitude') }} <b class="red-asterisk">*</b></label>
                        ...
                        <div class="form-group row">
                            <label for="longitude" class="col-md-4 col-form-label text-md-right">{{ __('route_segment.label.longitude') }} <b class="red-asterisk">*</b></label>
                        ...
                        <div class="form-group row">
                            <label for="delivery_route_id" class="col-md-4 col-form-label text-md-right">{{ __('route_segment.label.delivery_route_id') }} <b class="red-asterisk">*</b></label>
