...
<div class="container-fluid padding-20">
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">{{ __('delivery_route.title_import_export') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('delivery_route.import_file') }}" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div class="col-3">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fa fa-upload"></i> {{ __('delivery_route.input.click_import') }}
                                </button>
                            </div>
                            <div class="col-3">
